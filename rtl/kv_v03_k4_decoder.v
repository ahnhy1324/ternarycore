// kv_v03_k4_decoder.v -- K4 specialization of the PACKED5 page decoder.
// SPDX-License-Identifier: CERN-OHL-S-2.0
`timescale 1ns / 1ps
`default_nettype none

module kv_v03_k4_decoder (
    ...
    kv_v03_symbol_decoder #(
        .SYMBOL_WIDTH(4), .STREAM_IS_V(0), .MAX_SYMBOLS(16384)
    ) u_decoder (
        .clk(clk), .rst_n(rst_n), .clear(1'b0), .start(start),
        .integrity_passed(integrity_passed), .stream_is_v(1'b0),
        .raw_mode(raw_mode),
